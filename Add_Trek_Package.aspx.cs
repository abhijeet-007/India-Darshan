...
public partial class Add_Trek_Package : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string query = "insert into TPackageData (TPgName,TPgPrice,TPgDescription,TName,TPgDetails) values (@PgName, @PgPrice, @PgDescription ,@PName ,@TPgDetails)";
            ...
            cmd.Parameters.AddWithValue("@TPgDetails", TextBox10.Text);
            conn.Open(); ;
            cmd.ExecuteNonQuery();
            conn.Close();
            //SqlCommand cmd = new SqlCommand(query, conn);

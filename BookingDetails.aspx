<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="BookingDetails.aspx.cs" Inherits="BookingDetails" %>
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" 
                        ErrorMessage="Enter only alphabets" ControlToValidate="TextBox8" 
            ...
            <tr style="height:30px">
                ...
                <asp:TextBox ID="TextBox7" runat="server" BorderStyle="Solid" BorderWidth="2px" 
                    ...
                    <ajaxToolkit:CalendarExtender ID="TextBox7_CalendarExtender" runat="server" 
                        BehaviorID="TextBox7_CalendarExtender" TodaysDateFormat="d MMMM, yyyy" PopupButtonID="ImageButton1" 
                        TargetControlID="TextBox7" Format="dd/MM/yyyy">

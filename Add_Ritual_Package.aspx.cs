...
public partial class Add_Ritual_Package : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string query = "insert into RPackageData (RPgName,RPgPrice,RPgDescription,RName,RPgDetails) values (@PgName, @PgPrice, @PgDescription ,@PName ,@RPgDetails)";
            ...
            cmd.Parameters.AddWithValue("@RPgDetails", TextBox10.Text);
            conn.Open(); ;
            cmd.ExecuteNonQuery();
            conn.Close();
            //SqlCommand cmd = new SqlCommand(query, conn);

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Rituals.aspx.cs" Inherits="Rituals" %>
...
<div class="bg-white">
    ...
    <div>
     ...
     <h4>&nbsp;
         <asp:Label ID="Label3" runat="server" ForeColor="#000066" style="text-align: center" 

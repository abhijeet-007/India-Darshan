...
public partial class Add_Trek_Point : System.Web.UI.Page
{
            ...
            if (FileUpload2.HasFile || FileUpload3.HasFile || FileUpload4.HasFile)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        FileUpload4.SaveAs(Server.MapPath("~/Uploads/Trekpoints/") + Path.GetFileName(FileUpload4.FileName));
                        String link = "Uploads/Trekpoints/" + Path.GetFileName(FileUpload2.FileName);
                        String link1 = "Uploads/Trekpoints/" + Path.GetFileName(FileUpload3.FileName);
                        String link2 = "Uploads/Trekpoints/" + Path.GetFileName(FileUpload4.FileName);
                        string query = "insert into TrekData (TName,TImage,TDescription,TImage1,TImage2,SName) values (@state, @image, @description, @image1, @image2, @sname)";

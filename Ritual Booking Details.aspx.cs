...
public partial class Ritual_Booking_Details : System.Web.UI.Page
{
    int price;
    int quantity1;
    int totalprice;
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["ID"] != null)
            {
                if (Session["buyitems"] == null)
                {
                    ...
                    String myquery = "select * from RPackageData where ID=" + Request.QueryString["id"];
                    ...
                    da.Fill(ds);
                    dr["sno"] = 1;
                    dr["pgname"] = ds.Tables[0].Rows[0]["rpgname"].ToString();
                    dr["pgprice"] = ds.Tables[0].Rows[0]["rpgprice"].ToString();
                    dr["pgdescription"] = ds.Tables[0].Rows[0]["rpgdescription"].ToString();
                    dr["quantity"] = Request.QueryString["quantity"];
                    dr["pname"] = ds.Tables[0].Rows[0]["rname"].ToString();
                    price = Convert.ToInt16(ds.Tables[0].Rows[0]["rpgprice"].ToString());
                    quantity1 = Convert.ToInt16(Request.QueryString["quantity"].ToString());
                    totalprice = price * quantity1;
                    dr["totalprice"] = totalprice;
                    pgname1 = (ds.Tables[0].Rows[0]["rpgname"].ToString());
                    pname1 = (ds.Tables[0].Rows[0]["rname"].ToString());
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        data.Add("surl", "http://localhost:2430/India%20Darshan/Success_Payment.aspx");
        data.Add("furl", "http://localhost:2430/India%20Darshan/FailurePayment.aspx");
    ...
    private void SendEmail()
    {
        try
        {
            ...
            sb.Append("<a href=http://localhost:2430/India%20Darshan/View%20Details.aspx?ID=" + pid.ToString());

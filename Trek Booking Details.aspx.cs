...
public partial class Trek_Booking_Details : System.Web.UI.Page
{
    int price;
    int quantity1;
    int totalprice;
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["ID"] != null)
            {
                if (Session["buyitems"] == null)
                {
                    ...
                    String myquery = "select * from TPackageData where ID=" + Request.QueryString["id"];
                    ...
                    da.Fill(ds);
                    dr["sno"] = 1;
                    dr["pgname"] = ds.Tables[0].Rows[0]["tpgname"].ToString();
                    dr["pgprice"] = ds.Tables[0].Rows[0]["tpgprice"].ToString();
                    dr["pgdescription"] = ds.Tables[0].Rows[0]["tpgdescription"].ToString();
                    dr["quantity"] = Request.QueryString["quantity"];
                    dr["pname"] = ds.Tables[0].Rows[0]["tname"].ToString();
                    price = Convert.ToInt16(ds.Tables[0].Rows[0]["tpgprice"].ToString());
                    quantity1 = Convert.ToInt16(Request.QueryString["quantity"].ToString());
                    totalprice = price * quantity1;
                    dr["totalprice"] = totalprice;
                    pgname1 = (ds.Tables[0].Rows[0]["tpgname"].ToString());
                    pname1 = (ds.Tables[0].Rows[0]["tname"].ToString());

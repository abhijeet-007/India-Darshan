<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="AllRitual Place.aspx.cs" Inherits="AllRitual_Place" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<div>
    <asp:DataList ID="DataList1" runat="server" DataKeyField="RName" 
            ...
            <table style="width: 100%; height: 129px">
                ...
                <tr>
                    <td style="height: 65px">
                        <asp:Label ID="Label3" runat="server" Text='<%# Eval("RDescription") %>'></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="width: 82px">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [RitualData]"></asp:SqlDataSource>
        </div>
</asp:Content>

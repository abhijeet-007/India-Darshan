<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Trek Booking Details.aspx.cs" Inherits="Trek_Booking_Details" %>
...
<div>
        ...
        <table  style="width:100%">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                        ErrorMessage="Enter Name" ForeColor="Red" ControlToValidate="TextBox8"></asp:RequiredFieldValidator>
            ...
            <tr>
                <td  colspan="2" style="width:214px; text-align: center; height: 37px;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                        ErrorMessage="Enter address" ForeColor="Red" ControlToValidate="TextBox10"></asp:RequiredFieldValidator>
                         &nbsp;<asp:RegularExpressionValidator Display = "Dynamic" 
                        ControlToValidate = "TextBox10" ID="RegularExpressionValidator6" 
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ForeColor="Black">
            ...
            <tr>
                ...
                <asp:ImageButton ID="ImageButton1" runat="server" Height="26px" 
                    ImageUrl="~/images/calendar-400x400.png" Width="28px" 
                         />
                <asp:TextBox ID="TextBox7" runat="server" BorderStyle="Solid" BorderWidth="2px" 
                        Height="30px" Width="202px" ReadOnly="True"></asp:TextBox>
                        <ajaxToolkit:CalendarExtender ID="TextBox7_CalendarExtender" TodaysDateFormat="d MMMM, yyyy" PopupButtonID="ImageButton1" runat="server" 
                        BehaviorID="TextBox7_CalendarExtender" Format="dd/MM/yyyy" TargetControlID="TextBox7">

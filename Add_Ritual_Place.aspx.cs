...
public partial class Add_Ritual_Place : System.Web.UI.Page
{
            ...
            if (FileUpload2.HasFile || FileUpload3.HasFile || FileUpload4.HasFile)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        FileUpload4.SaveAs(Server.MapPath("~/Uploads/Ritualplaces/") + Path.GetFileName(FileUpload4.FileName));
                        String link = "Uploads/Ritualplaces/" + Path.GetFileName(FileUpload2.FileName);
                        String link1 = "Uploads/Ritualplaces/" + Path.GetFileName(FileUpload3.FileName);
                        String link2 = "Uploads/Ritualplaces/" + Path.GetFileName(FileUpload4.FileName);
                        string query = "insert into RitualData (RName,RImage,RDescription,RImage1,RImage2) values (@state, @image, @description, @image1, @image2)";
